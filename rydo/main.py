    ...
    try:
        ...
        for i in elements_links[:5]:
            ...
            with open('output.txt', 'a', encoding='utf-8') as file:
                file.write(f"Название: {ser_title}\n")
                file.write(f"Ссылка: {i}\n")
                file.write(f"Цена: {ser_price}\n")
                file.write(f"Номер телефона: {ser_num}\n")
                file.write(f"Описание: {ser_description}\n")
                file.write('*' * 100 + '\n\n')
